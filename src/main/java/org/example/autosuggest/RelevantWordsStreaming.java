...
public class RelevantWordsStreaming {
   ...
   */
  public interface RelevantWordsStreamingOptions extends PipelineOptions, StreamingOptions {
    ...
    /**
     * Cloud Pub/Sub Dubscription
     */
    @Description("Cloud Pub/Sub Dubscription")
    @Required
  ...
  public static void main(String[] args) {
    RelevantWordsStreamingOptions options = PipelineOptionsFactory.fromArgs(args).withValidation()
      .as(RelevantWordsStreamingOptions.class);
    LOG.info("BEAM Redis: {}:{}", options.getRedisHost(), options.getRedisPort());

    Pipeline p = Pipeline.create(options);

    p.apply(PubsubIO.readStrings().fromSubscription(options.getSubscription()).fromTopic(options.getTopic()))
